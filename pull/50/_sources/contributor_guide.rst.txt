...
If you want to help maintaining and improving the ``tqecd`` package, you will need
...
Start by looking at the `issues list <https://github.com/tqec/tqecd/issues>`_.
...
If you are part of the ``tqec`` community, you will be able to
`create a branch <https://git-scm.com/book/en/v2/Git-Branching-Basic-Branching-and-Merging>`_
directly in the ``tqec/tqecd`` repository. If you are not, you can
`fork <https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo>`_
the ``tqec/tqecd`` repository on your own account
(`click here <https://github.com/tqec/tqecd/fork>`_) and create a branch there.
...
on the ``main`` branch of the ``tqec/tqecd`` repository. In the PR message, try to
